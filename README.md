...
- [Windows worker setup and operations (Japanese)](docs/windows-worker.md)
- [Standalone Linux worker (Japanese)](docs/linux-worker.md)
- [Mac, Windows, and Linux computer use (Japanese)](docs/computer-use.md)

...
py_compile() { python3 -m py_compile lib/aifactory_paths.py workflow/bin/run kanban/bin/kb glue/bin/intake glue/bin/dispatch console/bin/console console/bin/mcp console/lib/core.py bin/changelog-release; }

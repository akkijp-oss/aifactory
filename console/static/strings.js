...
const T = {
  ...
  "h": {
    ...
    "keys": "登録してある鍵", "keyAdd": "鍵を登録する", "quota": "残量（利用枠）", "quotaHistory": "残量の推移",
  ...
  "keys": { "count": "{n} 本", "never": "まだ起動していません", "assigned": "割り当てた回数: {n}（チケットの実行に鍵を渡した回数。起動回数とは別です）",
    ...
    "oiPending": "7 日枠（Fable）は Fable で問い合わせたときだけ分かります。次の観測を待っています。",
    "dbError": "残量の記録を読めませんでした（{e}）。",
    "hours24": "24 時間", "days7": "7 日" },
  ...
  "help": {
    ...
    "quotaBar": "バーの長さが残量、縦の線が窓の残り時間です。バーが線より左なら、時間の進みより速く消費しています。",
    "quotaHow": "残量は、鍵ごとに小さな問い合わせを 1 回送り、応答に付く利用枠の情報を読んで求めます。安いモデルで 5 分ごと、Fable で 15 分ごとに観測します。Fable の枠は Fable で問い合わせたときだけ分かります。",
    "quotaTimer": "定期的な観測は制御系の timer（aifactory-keys-probe.timer）が行います。「いま調べる」で、その場でも観測できます。",
    "quotaChart": "線は各鍵の残量の推移です。5 時間枠はリセットのたびに 100% へ戻るので、のこぎりの形になるのが普通です。",

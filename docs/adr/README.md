...
- [0087: 証明可能に死んでいる run でも `kb run-note` の門は開けない。記録上の後始末は退避で扱い、`finished` の有無という見方を 1 つに保つ](0087-provably-dead-runs-are-not-closed-through-the-run-note-gate.md)

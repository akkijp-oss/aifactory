...
CLI のコマンドとオプション、設定ファイルの項目をまとめています。操作の手順は [使い方](../guides/index.md)、内部の動作や設計は [仕組み](../concepts/index.md) を参照してください。
...
| `workflow/bin/run` | ワークフロー | runner 本体 | [run](cli-run.md) |
...
| `workflow/kit/workflows/<name>.yml` | [ワークフローの YAML](workflow-yml.md) |
...
| VM | Ubuntu 24.04、`dev` ユーザー、Claude Code、mise（Node 22、プロジェクトごとの Ruby / Node） |
